...
public class Complaint extends JFrame {
	Complaint()
    {
        JLabel txt = new JLabel("Enter your complain :");
        ...
        JButton Registerbtn=new JButton("Register Complain");
                ...
                if (tf.getText().isEmpty())
                {
                    ...
                    if(result == JOptionPane.YES_OPTION){
                        try {
                            ...
                            PreparedStatement s = connection.prepareStatement("insert into complaints (RegisterNo,Complaint,DateAndTime,status,department) values (?,?,?,?,?)");
                            ...
                            s.executeUpdate();
                            l1.setText("Complain registered successfully...!!!");
                            tf.setText(" ");
                            JOptionPane.showMessageDialog(panel, l1);
                            dispose();
                            new StudentLogin();                        
        ...
        setTitle("Student Complaint");  //setting title.
        setLocation(700,300);
